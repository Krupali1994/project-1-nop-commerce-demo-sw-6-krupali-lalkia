...
public class RegisterSteps {
    ...
    public void userEnterFirstname() {
        new RegisterPage().enterFirstName("Abc");
    }

    @And("User Enter lastname")
    public void userEnterLastname() {
        new RegisterPage().enterLastName("Xyz");
    }
    ...
    public void userSelectYear() {
        new RegisterPage().selectDateOfBirth("01", "01", "1990");
    }

    @And("User Enter email")
    public void userEnterEmail() {
        new RegisterPage().enterEmail("krupali123@gmail.com");
    }

    @And("User Enter password")
    public void userEnterPassword() {
        new RegisterPage().enterPassword("Krupali123");
    }

    @And("User Enter Confirm Password")
    public void userEnterConfirmPassword() {
        new RegisterPage().enterConfirmPassword("Krupali123");
    }
